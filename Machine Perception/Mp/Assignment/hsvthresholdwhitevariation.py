...
for file in files[0:]:
    ...
    upper_val = np.array([179,20,255]) # all 179 hue values, all 255 values, 50/255 saturation values, representing the white-gray-black range
    ...
    #make values whiter
    lower_val7 = np.array([0,0,160]) #lowest threshold is [0,0,0] black
    ...
    _,thresh1 = cv2.threshold(gray, 200, 255, cv2.THRESH_BINARY)  # ensure binary
