...
def split2d(img, cell_size, flatten=True):
    ...
    #print('1: ', str(type(cells)))
    #for i in cells:
    #    print('incel ', str(type(i)))
    #    for j in i:
    #         print('jcel ', str(type(j)))
...
def load_digits(fn):
    ...
    print('1: ', str(type(digits)))
    print('2: ', str(type(digits[0])))

    cv2.imshow('digit',digits[0])
    cv2.waitKey(0)
